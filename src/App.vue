...
<template>
  ...
  <main class="page-wrapper-two">
    ...
    <section
      id="home"
      class="slider-style-5 rn-section-gap pb--110 align-items-center with-particles"
    >
            ...
            <div class="banner-inner">
              ...
              <div class="col-lg-10 offset-lg-1 mt--60">
                <p class="has-drop-cap" style="text-align: justify">
                  Basically I am A Bangladeshi Origin Full-time Web Developer
                  and A Software Engineer By Profession Who Is Living In Japan
                  and Also A Photographer & Video Editor By Choice. I am At A
                  Time A Hard Working And Super Lazy. I Can Sleep For 17 Hours
                  Straight & Also Can Code From 10:00 PM to 9:00 AM
                  Continuously. My Potential For You Depends On How You Want To
                  Get It.
                </p>
              </div>
              <div class="button-area">
                <a class="rn-btn" href="#contacts"><span>Download CV</span></a>
              </div>
            </div>
          </div>
        </div>
                      ...
                      <div class="main-content">
                        <div class="inner text-center">
                          <div class="thumbnail">
                            <a href="#"
                              ><img
                                src="@/assets/images/client/png/brand-05.png"
                                alt="Client-image"
                            /></a>
                          </div>
                          <div class="seperator"></div>
          ...
          <div class="modal-body">
            ...
            <div class="news-details">
              ...
              <p>
                ...
                torquent per conubia nostra, per inceptos himenaeos. Nunc vitae
                nisi tortor. Morbi leo nulla, posuere vel lectus a, egestas
                posuere lacus. Fusce eleifend hendrerit bibendum. Morbi nec
                efficitur ex.
              </p>
